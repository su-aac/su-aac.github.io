...
var _a2, _b2;
var wrap2 = ENABLE_SHADYDOM_NOPATCH2 && ((_a2 = window.ShadyDOM) == null ? void 0 : _a2.inUse) && ((_b2 = window.ShadyDOM) == null ? void 0 : _b2.noPatch) === true ? window.ShadyDOM.wrap : (node) => node;
...
var isCompiledTemplateResult = (value) => {
  var _a3;
  return ((_a3 = value == null ? void 0 : value["_$litType$"]) == null ? void 0 : _a3.h) != null;
};
var isSingleExpression = (part) => part.strings === void 0;

// node_modules/@lit-labs/ssr-client/development/lib/hydrate-lit-html.js
var NODE_MODE2 = false;
var { TemplateInstance: TemplateInstance2, isIterable: isIterable2, resolveDirective: resolveDirective2, ChildPart: ChildPart3, ElementPart: ElementPart2 } = _$LH2;
...
var openChildPart = (rootValue, marker2, stack, options) => {
  let value;
  let part;
  if (stack.length === 0) {
    part = new ChildPart3(marker2, null, void 0, options);
    value = rootValue;
  } else {
    const state = stack[stack.length - 1];
    if (state.type === "template-instance") {
      part = new ChildPart3(marker2, null, state.instance, options);
      state.instance._$parts.push(part);
      value = state.result.values[state.instancePartIndex++];
      state.templatePartIndex++;
    } else if (state.type === "iterable") {
      part = new ChildPart3(marker2, null, state.part, options);
  ...
  if (value === noChange) {
    ...
    if (marker2.data === markerWithDigest) {
      const template = ChildPart3.prototype._$getTemplate(value);
...
var closeChildPart = (marker2, part, stack) => {
  if (part === void 0) {
...
var digestForTemplateResult = (templateResult) => {
  ...
  return NODE_MODE2 ? Buffer.from(str, "binary").toString("base64") : btoa(str);
};
...
@lit-labs/ssr-client/development/lit-element-hydrate-support.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LOOFF6OQ.js.map
